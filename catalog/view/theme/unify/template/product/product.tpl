...
<div class="container">
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        <?php if ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-6 md-margin-bottom-50'; ?>
        <?php } else { ?>
        <?php $class = 'col-sm-8 md-margin-bottom-50'; ?>
        <?php } ?>
        <div class="<?php echo $class; ?>">
          <div class="row margin-bottom-20">
          <?php if ($thumb || $images) { ?>
          <div class="ms-showcase2-template col-sm-7">
            <div class="master-slider ms-skin-default" id="masterslider">
            <?php if ($thumb) { ?>
            <div class="ms-slide">
            <img class="ms-brd" src="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
              <img class="ms-thumb" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
            </div>
            <?php } ?>
            <?php if ($images) { ?>
            ...
            <div class="ms-slide">
              ...
              <img class="ms-thumb" src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
            </div>
            <?php } ?>
            <?php } ?>
            </div>
          ...
          <?php } ?>
            <div class="col-sm-5">
              ...
              <a href="<?php echo $downloadurl; ?>" data-toggle="tooltip" class="btn btn-primary"><?php echo $downloadcad; ?>  <i class="fa fa-cloud-download"></i></a>
            </div>
          </div>
          <script type="text/javascript">
            $(document).ready(function(){
              ...
              slider.control('thumblist' , {autohide:false ,dir:'h',arrows:false, align:'bottom', width:100, height:100, margin:5, space:5});
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{},"image":{"viewList":["qzone","tsina","tqq","renren","weixin","fbook","twi","linkedin"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tsina","tqq","renren","weixin","fbook","twi","linkedin"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
      ...
      <?php if ($products) { ?>
      <div class="headline"><h2><?php echo $text_related; ?></h2></div>
      <div class="row">
        <?php $i = 0; ?>
        ...
        <?php } ?>
        <div class="<?php echo $class; ?>">
          <div class="oc_product-thumb transition" >
