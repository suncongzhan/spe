...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="headline"><h2><?php echo $text_location; ?></h2></div>
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="row">
            <?php if ($image) { ?>
            <div class="col-sm-6"><img src="<?php echo $image; ?>" alt="<?php echo $store; ?>" title="<?php echo $store; ?>" class="img-thumbnail" /></div>
            <?php } ?>
            ...
            <div class="col-sm-12">
              ...
              <script type="text/javascript" src="catalog/view/theme/unify/plugins/gmap/gmap.js"></script>
              <script>
                    ...
                    initMap: function () {
                      ...
                      $(document).ready(function(){
                        ...
                        var marker = map.addMarker({
                          lat: 30.165674,
                          lng: 121.181528,
                          title: 'Ningbo Shunchi pneumatic Element co., Ltd'
                        });
                      });
                    },
      ...
      <?php if ($locations) { ?>
      <div class="headline"><h2><?php echo $text_store; ?></h2></div>
          ...
          <div class="panel-collapse collapse" id="collapse-location<?php echo $location['location_id']; ?>">
            <div class="panel-body">
              <div class="row">
                ...
                <?php } ?>
                <div class="col-sm-6"><strong><?php echo $location['name']; ?></strong><br />
                  <address>
